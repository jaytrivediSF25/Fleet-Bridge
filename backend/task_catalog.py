...
TASK_CATALOG: list[TaskDef] = [
    ...
    TaskDef(
        ...
        vendors=["Amazon Normal", "Amazon Internal"],
        speed_range=(1.0, 1.8),
        duration_mult=1.3,
    ),
    ...
    TaskDef(
        ...
        vendors=["Amazon Normal", "Balyo", "Amazon Internal"],
        speed_range=(1.5, 3.0),
    ),
